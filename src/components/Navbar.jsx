        ...
        <div className='container flex justify-between items-center'>
            ...
            {/* Barra de navegacion */}
              ...
              <div className='relative group hidden sm:block'>
                ...
                {/* boton orden */}
                <button onClick={() => alert("Pedido no disponible en estos momentos")} className='bg-gradient-to-r from-primary to-secundary transition-all duration-200 text-white py-1 px-4 rounded-full flex items-center gap-3 group'>
